        ...
        <div class="row">
          <div class="col-md-7">
            <div class="shopping-item">
              ...
              <div class="navbar-header">
                  <h1><a href="webpage.php"><img style="width: 165px; height: 50px;" src="img/brandlogo.png"></a></h1>
              </div>
              </div>
              <div class="navbar-header">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="footer-about-us">
              <h2>
                <a href="webpage.php">G-shock Casio</a>
              </h2>
              <p>
                Chúng tôi chuyên cung cấp các sản phẩm đồng hồ 
                G-shock Casio chính hãng, giá rẻ, đặt hàng - thanh 
                toán hoàn toàn online
              </p>
