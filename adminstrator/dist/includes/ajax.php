...
if ($action == 'addwatch') {
   ...
   $sql = "INSERT INTO WATCH (category_id, title, price, quantity, description, productimage, discount_id, created_at, updated_at)
...
if ($action == 'editwatch') {
   ...
   // Thực hiện truy vấn cập nhật thông tin 
   $sql = "UPDATE WATCH SET category_id = $category_id, title = '$title', price = $price, quantity = $quantity, 
...
if ($action == 'editwatchcategory') {
   ...
   // Thực hiện truy vấn cập nhật thông tin Category
   $sql = "UPDATE WATCHCategory SET name = '$name' WHERE id = $id;";
...
if ($action == 'addWATCHcategory') {
   ...
   // Thực hiện truy vấn cập nhật thông tin Category
   $sql = "INSERT INTO WATCHCategory (name) VALUES ('$name')";
...
if ($action == 'deletecategory') {
   // Xử lý xoá
   $id = $_POST['id'];
   $sql = "DELETE FROM WATCHCategory WHERE id = $id";
   execute($sql);
};
