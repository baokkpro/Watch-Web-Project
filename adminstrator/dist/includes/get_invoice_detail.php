...
if (isset($_GET['invoice_id'])) {
    ...
    $detail_sql = "SELECT Invoice_Detail.*, INVOICE.total_money as total, WATCH.id AS WATCH_id, WATCH.title AS watch_title, WATCH.productimage
               FROM Invoice_Detail
               JOIN WATCH ON Invoice_Detail.product_id = WATCH.id
