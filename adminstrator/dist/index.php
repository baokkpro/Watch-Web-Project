...
$sqlHotWATCHGenres = "SELECT WATCHCategory.name AS genre, COUNT(*) AS watch_count FROM INVOICE
                    INNER JOIN Invoice_Detail ON INVOICE.id = Invoice_Detail.order_id
                    INNER JOIN WATCH ON Invoice_Detail.product_id = WATCH.id
                    INNER JOIN WATCHCategory ON WATCH.category_id = WATCHCategory.id
                    GROUP BY genre ORDER BY watch_count DESC LIMIT 1";
...
$hotWATCHGenres = execute_result($sqlHotWATCHGenres);
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-danger text-white mb-4">
                            <div class="card-body">Thể loại WATCH hot: <?php echo $hotWATCHGenres[0]['genre']; ?></div>
                        </div>
                    </div>
                </div>
                <div class="row">
